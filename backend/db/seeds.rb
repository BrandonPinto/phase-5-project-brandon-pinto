...
PersonalEvent.create(user_id: 1, def_id: 74, title: "start", start: "2022-10-08", end: "2022-10-09")
PersonalEvent.create(user_id: 2, def_id: 76, title: "wooooooo", start: "2022-10-31", end: "2022-11-01")
PersonalEvent.create(user_id: 3, def_id: 80, title: "do something", start: "2022-10-20", end: "2022-10-21")
Contact.create(user_id: 1, email: "antonio@gmail.com", first_name: "antonio", last_name: "bruh", company: "flatiron", phone_number: 7182224244, address: "New York", notes: "this place fuckin sucks")
Contact.create(user_id: 2, email: "shane@gmail.com", first_name: "shane", last_name: "bruv", company: "google", phone_number: 7183334244, address: "New York", notes: "i love this place so much")
Contact.create(user_id: 3,email: "karl@gmail.com", first_name: "karl", last_name: "stinky", company: "facebook", phone_number: 7188873333, address: "New York", notes: "what can i even say??")
